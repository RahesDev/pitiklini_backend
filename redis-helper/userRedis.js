...
getUser = exports.getUser = async (userId, callback) => {
    ...
    try {
        var includeData = {
            uuid:1,email:1,createdDate:1,kycstatus:1,displayname:1,tfastatus:1,verifyEmail:1,referralCode:1,otpstatus:1,registerType:1,fiat_spot_status:1,
            account_status:1,deposit_status:1,AntiphisingStatus:1,AntiphisingEnabledStatus: 1, ptk_fee_status:1
        }
