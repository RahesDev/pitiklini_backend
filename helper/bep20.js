...
sendBEP20Transaction = exports.sendBEP20Transaction = async (sender, receiver, value, private, contractAddress, abi, callback) => {
    ...
    const web3 = new Web3(new Web3.providers.HttpProvider(process.env.BNB_WALLET));
    ...
    const BSC_MAIN = bsc_Common.custom({ name: "bnb", networkId: process.env.BNB_CHAIN, chainId: process.env.BNB_CHAIN });
                                                
    const transaction = new Tx(rawTransaction, { common: BSC_MAIN });
